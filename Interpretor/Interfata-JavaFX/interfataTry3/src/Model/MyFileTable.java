...
public class MyFileTable implements MyIFileTable<Integer, Pair<String, BufferedReader>> {
    ...
    public Collection<Integer> keys(){return this.fileTable.keySet();}
    ...
    public void clear(){this.fileTable.clear();}
    public Collection<Pair<String, BufferedReader>> values(){return this.fileTable.values();}
}
